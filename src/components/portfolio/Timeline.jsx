...
function Timeline() {
  return <section id="timeline" className="py-16">
      <div className="mx-auto w-[min(1000px,94vw)]">
        ...
        <div className="relative pl-6 sm:pl-10">
          <div className="absolute top-0 bottom-0 left-2 w-px sm:left-4" style={{ background: "var(--gradient-primary)" }} />
          {timeline.map((t, i) => <motion.div
    key={i}
