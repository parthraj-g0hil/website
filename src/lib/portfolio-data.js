export const RESUME_URL = "/parthraj_resume.pdf";
...
export const projects = [
  {
    ...
    problem:
      "A fintech client needed a secure, scalable 3-tier architecture on AWS with strict network isolation and compliance.",
    solution:
      "Designed VPC with public/private subnets, Transit Gateway peering, ALB + EC2 web tier, Lambda + RDS app tier, CloudWatch and CloudFormation IaC.",
    stack: ["VPC", "Transit Gateway", "EC2", "Lambda", "RDS", "CloudFormation", "Route53", "S3", "CloudWatch"],
    metrics: [
  ...
  },
  {
    ...
    problem:
      "Multiple gold-trading platforms required unified AWS infra with centralized SSO and consistent CI/CD.",
    solution:
      "Multi-account AWS with SAML SSO, RBAC via IAM Identity Center, in-house GitLab + runners, Grafana/Prometheus observability.",
  ...
  },
  {
    ...
    problem:
      "Legacy PHP / Node.js / Next.js stacks needed migration to AWS with disaster recovery guarantees.",
    solution:
      "AWS Migration Services, ECS deployments behind CloudFront + WAF, cross-region DR runbooks, blue/green deploys.",
    stack: ["AWS MGN", "ECS", "CloudFront", "WAF", "Route53", "S3"],
    metrics: [
...
export const certifications = [
  ...
  },
  {
    ...
    issuer: "Red Hat",
    color: "pink",
    logo: "https://images.credly.com/size/340x340/images/9f0f32d1-52ff-4315-b3de-b96b813f0522/image.png",
    skills: ["Linux admin", "systemd", "SELinux", "Storage & networking"],
  },
];

export const timeline = [
  { year: "2020", title: "Started B.Tech", body: "Computer Engineering at Silver Oak, Ahmedabad." },
